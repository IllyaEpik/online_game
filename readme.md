...
+ pillow; модуль для роботи з зображеннями / a module for working with images
...
7. Right-click (or Control + Click) on the folder -> Select "Get Info"-> Copy the path in the "Where" field.  
...
### Online_game/modules/buttons.py:
```python
